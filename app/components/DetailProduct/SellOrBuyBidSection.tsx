...
const SellOrBuyBidSection: React.FC<SellOrBuyBidSectionProps> = ({
  type,
  price,
  ...
  return (
    <Section>
      ...
      <Button
        ...
        disabled={!inputPrice}
        onClick={() =>
          router.push(`${pathname}?type=${type}&size=${params.size}`)
        }
      >
...
const Separator = styled.div<{ isError?: boolean }>`
  ...
  background-color: ${(props) =>
    props.isError ? 'red' : theme.colors.gray[100]};
  margin-bottom: 2rem;
`;
